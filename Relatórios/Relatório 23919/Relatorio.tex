...
um sistema de autorização que permite apenas ao dono de uma lista gerir a mesma.
...
ou apenas para separar os animes de acordo com o seu gosto, como por exemplo, separar os animes por aqueles mais nostálgicos, ou por aqueles que
...
de curso.\\
Os erros associados à inserção de dados na base de dados, necessitou de eliminar a tabela intermediária que guardava os animes das listas dos utilizadores,
...
\\
\newpage
Os erros associados à comunicação incorreta entre o Frontend e o Backend, que necessitaram de utilizar alguns métodos novos 
